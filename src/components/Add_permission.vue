<template>
  <div class="min-h-screen bg-gray-50 p-8">
    ...
    <header class="flex justify-between items-center mb-6">
      <h1 class="text-xl font-bold text-gray-800">Add New Permission</h1>
    </header>

    <!-- Form Card -->
    <div class="bg-white rounded-xl shadow p-6 max-w-4xl mx-auto">
      <h2 class="text-lg font-semibold mb-1">Add New Permission</h2>
      <p class="text-sm text-gray-500 mb-6">
        Make sure that you are in deed need this Permission before createing it.
      </p>
